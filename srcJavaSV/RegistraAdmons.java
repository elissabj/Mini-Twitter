 ...
 */
@WebServlet(name = "RegistraAdmons", urlPatterns = {"/RegistraAdmons"})
public class RegistraAdmons extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                BaseDatos.conectar();
                rsValida = BaseDatos.consulta("call sp_AltaAdministrador('"+idPersona+"','"+usr+"','"+psw+"','"+Nombre+" "+ApePa+" "+ApeMa+"','','')");
                
                while (rsValida.next()) {
                    if (rsValida.getString("Respuesta").equalsIgnoreCase("Administrador Registrado")) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RegistraAdmons</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("</body>");
            out.println("</html>");

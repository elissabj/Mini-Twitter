...
public class EliminarPublicacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                BaseDatos.conectar();
                rsValida = BaseDatos.consulta("call sp_BajaPublicacion('"+idPublicacion+"')");
                
                while (rsValida.next()) {                    
                    if(rsValida.getString("Respuesta").equalsIgnoreCase("Publicacion Inexistente")){
                        response.sendRedirect("MenuEmpresa.jsp");
                    }else if(rsValida.getString("Respuesta").equalsIgnoreCase("Publicacion Eliminada")){

 ...
 */
@WebServlet(name = "EliminarEncuesta", urlPatterns = {"/EliminarEncuesta"})
public class EliminarEncuesta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                BaseDatos.conectar();
                rsValida = BaseDatos.consulta("call sp_BajaEncuesta('"+idEncuesta+"');");
                
                while (rsValida.next()) {                    
                    if(rsValida.getString("Respuesta").equalsIgnoreCase("Encuesta Inexistente")){
                        response.sendRedirect("MenuEmpresa.jsp");
                    }else if(rsValida.getString("Respuesta").equalsIgnoreCase("Encuesta Eliminada")){
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EliminarEncuesta</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("</body>");
            out.println("</html>");
